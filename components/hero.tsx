      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 z-30">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex justify-center mb-6 px-4">
            <div className="relative w-32 h-32 rounded-full bg-white backdrop-blur-xs flex items-center justify-center overflow-hidden">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-linear-to-r from-primary to-blue-600 dark:from-primary dark:to-blue-400 px-4">
